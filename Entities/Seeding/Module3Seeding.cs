using System;
//using c_sharp_entity_framework.Migrations;
...
namespace c_sharp_entity_framework.Entities.Seeding
{
    public static class Module3Seeding
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var cinemaHall2DAgora = new CinameHall()
            {
                Id = 1,
                CinemaId = agora.Id,
                Cost = 220,
            ...
            var cinemaHall3DAgora = new CinameHall()
            {
                Id = 2,
                CinemaId = agora.Id,
                Cost = 320,
            ...
            var cinemaHall2DSambil = new CinameHall()
            {
                Id = 3,
                CinemaId = sambil.Id,
                Cost = 200,
            ...
            var cinemaHall3DSambil = new CinameHall()
            {
                Id = 4,
                CinemaId = sambil.Id,
                Cost = 290,
            ...
            var cinemaHall2DMegacentro = new CinameHall()
            {
                Id = 5,
            ...
            var cinemaHall3DMegacentro = new CinameHall()
            {
                Id = 6,
                CinemaId = megacentro.Id,
                Cost = 330,
            ...
            var cinemaHallCXCMegacentro = new CinameHall()
            {
                Id = 7,
                CinemaId = megacentro.Id,
                Cost = 450,
            ...
            var cinemaHall2DAcropolis = new CinameHall()
            {
                Id = 8,
            ...
            modelBuilder.Entity<CinameHall>().HasData(cinemaHall2DMegacentro, cinemaHall3DMegacentro, cinemaHallCXCMegacentro, cinemaHall2DAcropolis, cinemaHall2DAgora, cinemaHall3DAgora, cinemaHall2DSambil, cinemaHall3DSambil);
            ...
            var entityCinemaHallMovie = "CinameHallMovie";
            var cinemaHallsId = "CinameHallsId";

...
namespace c_sharp_entity_framework.Migrations
{
    ...
    [Migration("20221230044332_ProductsEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("c_sharp_entity_framework.Entities.Products", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("c_sharp_entity_framework.Entities.Merchandising", b =>
                {
                    b.HasBaseType("c_sharp_entity_framework.Entities.Products");
            ...
            modelBuilder.Entity("c_sharp_entity_framework.Entities.RentableMovie", b =>
                {
                    b.HasBaseType("c_sharp_entity_framework.Entities.Products");
            ...
            modelBuilder.Entity("c_sharp_entity_framework.Entities.Merchandising", b =>
                {
                    b.HasOne("c_sharp_entity_framework.Entities.Products", null)
                        .WithOne()
                        .HasForeignKey("c_sharp_entity_framework.Entities.Merchandising", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("c_sharp_entity_framework.Entities.RentableMovie", b =>
                {
                    b.HasOne("c_sharp_entity_framework.Entities.Products", null)
                        .WithOne()
                        .HasForeignKey("c_sharp_entity_framework.Entities.RentableMovie", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
